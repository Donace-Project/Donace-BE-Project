...
public class UserService : IUserService
{
    ...
    public async Task<ResponseModel<UpdateUserModel>> UpdateProfileAsync(UpdateUserModel model)
    {
        try
        {
            ...
            return new ResponseModel<UpdateUserModel>(true, ResponseCode.Donace_BE_Project_CustomerService_Success, model);
        }
        catch(Exception ex )
        {
    ...
    public async Task<ResponseModel<UserModel>> GetProfileAsync()
    {
        try
        {
            ...
            return new ResponseModel<UserModel>(true, ResponseCode.Donace_BE_Project_CustomerService_Success, result);
        }
        catch(Exception ex)
        {
