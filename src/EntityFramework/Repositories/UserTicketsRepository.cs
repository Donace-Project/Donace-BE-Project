...
{
    public class UserTicketsRepository : RepositoryBase<UserTicket>, IUserTicketsRepository
    {
        public UserTicketsRepository(CalendarDbContext db, IUserProvider userProvider) : base(db, userProvider)
        {
        }
    }
}
